...
export const layers: LayerSpecificationWithZIndex[] = [
  {
    id: 'background',
    type: 'background',
    paint: {
  ...
  },
  {
    ...
    layout: {
      ...
      'icon-size': [
        ...
        0.01,
        22,
        ['max', ['*', ['to-number', ['coalesce', ['get', 'crown_diameter'], 5]], 0.1], 0.3],
      ],
  ...
  },
  {
    ...
    layout: {
      ...
      'icon-size': ['interpolate', ['linear'], ['zoom'], 16, 0.3, 20, 1],
      'icon-allow-overlap': true,
    },
  },
  {
    ...
    layout: {
      'icon-image': 'toilet',
      'icon-size': ['interpolate', ['linear'], ['zoom'], 16, 0.4, 20, 1.2],
      'icon-allow-overlap': true,
    },
  },
  {
  ...
  },
  {
    ...
    layout: {
      ...
      'icon-size': ['interpolate', ['linear'], ['zoom'], 17, 0.2, 22, 1],
      'icon-allow-overlap': true,
      'icon-anchor': 'center',
      'text-variable-anchor': ['top', 'bottom'],
      'text-field': '{name}',
      'text-size': ['interpolate', ['linear'], ['zoom'], 18, 9, 20, 14],
      'text-optional': true,
      'text-font': ['Open Sans Regular'],
      'text-radial-offset': ['interpolate', ['linear'], ['zoom'], 18, 1, 20, 2],
    },
    paint: {
      'text-halo-color': 'rgba(241, 241, 241, 0.8)',
      'text-halo-width': 3,
  ...
  },
  {
    ...
    layout: {},
    paint: {
      'line-color': ['match', ['get', 'phases'], 1, '#0500A5', 3, '#A50B07', '#333'],
      'line-width': ['interpolate', ['linear'], ['get', 'amps'], 16, 1, 400, 6],
    },
  },
  {
    id: 'power_distro',
    ...
    layout: {
      ...
      'icon-size': ['interpolate', ['linear'], ['zoom'], 16, 0.1, 23, 1],
      'icon-allow-overlap': true,
      'icon-anchor': 'center',
      'text-optional': true,
      'text-field': '{name}',
      ...
      'text-radial-offset': ['interpolate', ['linear'], ['zoom'], 18, 1.2, 20, 2],
      'text-max-width': 6,
    },
    paint: {
      'text-halo-color': 'rgba(241, 241, 241, 0.8)',
...

  {
    ...
    layout: {
      ...
      'icon-size': ['interpolate', ['linear'], ['zoom'], 16, 0.3, 24, 1],
      'icon-allow-overlap': true,
      'icon-anchor': 'center',
      'text-optional': true,
      'text-field': '{name}',
  ...
  },
  {
    ...
    source: 'site_plan',
    minzoom: 16,
    'source-layer': 'water_pipes_event',
    paint: {
      'line-color': 'rgba(80,80,255,1)',
      'line-width': 3,
    },
  },
  {
    ...
    source: 'site_plan',
    minzoom: 16,
    'source-layer': 'water_manholes',
    paint: {
      'circle-color': 'rgba(140,140,255,1)',
      'circle-radius': ['interpolate', ['linear'], ['zoom'], 17, 1, 20, 5],
      'circle-stroke-width': 1,
    },
  },
  {
    id: 'water_points_label',
    type: 'symbol',
    source: 'site_plan',
    minzoom: 16,
    'source-layer': 'water_points_event',
  ...
  },
  {
    ...
    layout: {
      'text-field': '{name}',
      'text-font': ['Open Sans Regular'],
      'text-radial-offset': ['interpolate', ['linear'], ['zoom'], 17, 1.1, 21, 2],
      'text-variable-anchor': ['top', 'bottom'],
      'text-size': ['interpolate', ['linear'], ['zoom'], 17, 8, 20, 16],
    },
    paint: {
  ...
  },
  {
    ...
    layout: {
      'icon-image': 'datenklo',
      'icon-size': ['interpolate', ['linear'], ['zoom'], 17, 0.3, 22, 1.8],
      'icon-allow-overlap': true,
      'icon-anchor': 'bottom',
      'text-anchor': 'top',
      'text-field': '{name}',
  ...
  },
  {
    ...
    layout: {
      'text-field': '{name}',
      'text-font': ['Raleway SemiBold'],
      'text-size': ['interpolate', ['linear'], ['zoom'], 16, 9, 23, 50],
      'text-max-angle': 10,
      'text-max-width': 6,
    },
    paint: {
  ...
  },
  {
    ...
    layout: {
      'text-field': 'Catering',
      'text-font': ['Raleway SemiBold'],
      'text-size': ['interpolate', ['linear'], ['zoom'], 15, 7, 23, 30],
      'text-max-angle': 10,
    },
    paint: {
      'text-halo-color': 'rgba(120, 120, 120, 1)',
  ...
  },
  {
    ...
    paint: {
      ...
      'text-halo-blur': 1,
      'text-color': 'rgba(250, 250, 250, 1)',
      'icon-opacity': ['case', ['boolean', ['feature-state', 'grist-selected'], false], 1, 0.3],
    },
  },
  /*
  {
    id: 'grist-markers-selected',
    type: 'symbol',
    source: 'grist_markers',
    layout: {
      'icon-image': 'marker',
